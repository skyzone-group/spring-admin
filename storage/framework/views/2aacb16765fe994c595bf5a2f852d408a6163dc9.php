                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="badge badge-light"><?php echo app('translator')->get('global.amount'); ?> : <?php echo e($botusers->total()); ?></span>
                            <div class="card-tools">
                                <div class="btn-group">
                                    ...
                                    <a href="<?php echo e(route('botuserIndex')); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-redo-alt"></i> <?php echo app('translator')->get('global.clear'); ?></a>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped table-responsive-lg">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $botusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $botuser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="text-center"><?php echo e(date('H:i:s d-m-Y', strtotime($botuser->created_at))); ?></td>
                                        <td class="text-center"> <?php echo e($botuser->name); ?></td>
                                        <td class="text-center"><?php echo e($botuser->phone); ?></td>
                                        <td class="text-center"><?php echo e(sizeof($botuser->orders)); ?></td>
                                        <td class="text-center"><?php echo e($botuser->address == null ?'-' : $botuser->address); ?></td>
                                        <td class="text-center">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission.delete')): ?>
                                                <form action="<?php echo e(route('botuserEdit',$botuser->id)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="btn-group">
                                                        <a href="<?php echo e(route('botuserEdit',$botuser->id)); ?>" type="button" class="btn btn-info btn-sm"> <?php echo app('translator')->get('global.edit'); ?></a>
                                                    </div>
                                                </form>
                                            <?php endif; ?>
                                        </td>
                        ...
                        <div class="card-footer">
                            <?php echo e($botusers->withQueryString()->links()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n86342/public_html/dostavkabot.nodirsattorov.uz/resources/views/pages/botuser/index.blade.php ENDPATH**/ ?>