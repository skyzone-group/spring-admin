            ...
            <div class="col-8 offset-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('mailingUpdate',$mailing->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        <label>Текст</label>
                                        <textarea class="ckeditor form-control" name="text"><?php echo e(old('text',$mailing->text)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adminjon/web/khanchapan.khan-chapan.uz/public_html/resources/views/pages/mailing/edit.blade.php ENDPATH**/ ?>