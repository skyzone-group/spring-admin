                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('categoryUpdate',$category->id)); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" class="form-control" value="<?php echo e(old('name_en',$category->name_en)); ?>" required>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/t92074/public_html/spring-organic.skybox.uz/resources/views/pages/category/edit.blade.php ENDPATH**/ ?>