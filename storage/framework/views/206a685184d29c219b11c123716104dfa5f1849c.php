            ...
            <div class="col-8 offset-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('botuserUpdateaddress',$botuser->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group ">
                                ...
                                <a href="<?php echo e(route('orderIndex')); ?>" class="btn btn-default float-left"><?php echo app('translator')->get('global.cancel'); ?></a>
                            </div>
                        </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/t92074/public_html/izumrudniybot.skybox.uz/resources/views/pages/botuser/editaddress.blade.php ENDPATH**/ ?>