                            ...
                            <table class="table table-bordered table-striped table-responsive-lg">
                                ...
                                <?php $__currentLoopData = $mailings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mailing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><a target="_blank" href="<?php echo e(config('constants.bot.photo_url').$mailing->photo); ?>"><?php echo e($mailing->photo); ?></a> </td>
                                        ...
                                        <td>
                                            <?php if($mailing->total > 0): ?>
                                                <div class="progress progress-sm active">
                                                    <div class="progress-bar bg-success progress-bar-striped" role="progressbar"
                                                         aria-valuenow="<?php echo e($mailing->current); ?>" aria-valuemin="0" aria-valuemax="<?php echo e($mailing->total); ?>" style="width: <?php echo e($mailing->current * 100 / $mailing->total); ?>%">
                                                    </div>
                                                </div>
                                                <div>
                                                    <span style="font-size: 14px"><?php echo e(floor($mailing->current * 100 / $mailing->total)); ?>%</span>
                                                </div>
                                            <?php else: ?>
                                                No
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n86342/public_html/dostavkabot.nodirsattorov.uz/resources/views/pages/mailing/index.blade.php ENDPATH**/ ?>