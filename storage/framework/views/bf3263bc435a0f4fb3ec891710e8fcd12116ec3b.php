                        ...
                        <table id="dataTable" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="dataTable_info">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a target="_blank"  href="https://khanchapan.khan-chapan.uz/images/<?php echo e($product->photo); ?>"><?php echo e($product->photo); ?></a> </td>
                                    <td><?php echo e($product->category->name_ru); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adminjon/web/khanchapan.khan-chapan.uz/public_html/resources/views/pages/product/index.blade.php ENDPATH**/ ?>