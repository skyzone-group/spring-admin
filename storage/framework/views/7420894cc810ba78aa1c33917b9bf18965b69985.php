                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('categoryCreate')); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_en" class="form-control" value="<?php echo e(old('name_en')); ?>" required>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u1587871/data/www/admin.spring-organic.uz/resources/views/pages/category/add.blade.php ENDPATH**/ ?>