                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button onclick="changeStatus('<?php echo e($order->id); ?>', '0','st')" class="dropdown-item" href="">В обработке</button>
                                                    <button onclick="changeStatus('<?php echo e($order->id); ?>', '1','st')" class="dropdown-item" href="">Подтвержден</button>
                                                    <button onclick="changeStatus('<?php echo e($order->id); ?>', '2','st')" class="dropdown-item" href="">Выполняется</button>
                                                    <button onclick="changeStatus('<?php echo e($order->id); ?>', '3','st')" class="dropdown-item" href="">Выполнено</button>
    ...
    function changeStatus($x, $y, $t) {
        ...
        $.ajax({
            ...
            success:function (result) {
                if(result.status)
                {
                    let classes = ['warning','primary','primary','success','danger'];
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Web\OpenServer\domains\dostavkabot\resources\views/pages/order/index.blade.php ENDPATH**/ ?>