                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <table class="table table-striped">
                                                                ...
                                                                <?php $__currentLoopData = $order->orderitem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <td><?php echo e(isset($order->product->name_ru) ? $order->product->name_ru : 'Deleted'); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n86342/public_html/dostavkabot.nodirsattorov.uz/resources/views/pages/order/index.blade.php ENDPATH**/ ?>