                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('productUpdate',$product->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" name="name_en" id="name_en" class="form-control" value="<?php echo e(old('name_en',$product->name_en)); ?>" required>
                                    </div>
                                    <div class="col">
                                        <label>Описание на английском</label>
                                        <textarea rows="3" name="description_en" class="form-control"><?php echo e(old('description_en',$product->description_en)); ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" min="0" id="productCode" name="code" class="form-control" value="<?php echo e(old('code', $product->code)); ?>" required>
                                    </div>
                                    <div class="col-6">
                                        <label>Упаковка кода</label>
                                        <input type="text" min="0" id="packageCode" name="package_code" class="form-control" value="<?php echo e(old('package_code', $product->package_code)); ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="number" min="0" id="vatPercent" name="vat_percent" class="form-control" value="<?php echo e(old('vat_percent', $product->vat_percent)); ?>" required>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u1587871/data/www/admin.spring-organic.uz/resources/views/pages/product/edit.blade.php ENDPATH**/ ?>